...
# Print the calculated area of each object.
...
student1 = Student('Zach', 29, 88)
student2 = Student('Alice', 22, 75)

# Print and change grades.
#print_grade(student1)
#print_grade(student2)
#change_grade(student2)
...
dog1 = Dog("Bones", "Brown")
bird1 = Bird("Sonny", "Blue")

# Make each object speak.
#speak(cat1)
#speak(dog1)
#speak(bird1)
...
car1 = Car("blue")
plane1 = Plane("white")
bicycle1 = Bicycle("green")

# Make each object travel.
#travel(car1)
#travel(plane1)
#travel(bicycle1)